...
dictionary["mesh"] = {
    "Lz": 9.952,  # depth in km - always positive
    "Lx": 28.550,  # width in km - always positive
...
dictionary["absorving_boundary_conditions"] = {
    ...
    "pad_length": 0.9,  # thickness of the PML in the z-direction (km) - always positive
}
...
Wave_obj.set_mesh(mesh_parameters={"cells_per_wavelength": 3.0})
