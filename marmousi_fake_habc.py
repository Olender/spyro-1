...
model["acquisition"] = {
    "source_type": "Ricker",
    "num_sources": 10,
    "source_pos": spyro.create_transect((-0.01, 1.0), (-0.01, 15.0), 10),
    "frequency": 5.0,
    "delay": 1.0,
    "num_receivers": 500,
...
if comm.ensemble_comm.rank == 0:
    File("marmousi_with_pml.pvd", comm=comm.comm).write(vp)
...
tf = time.time()
parprint(f"Total simulation time, for marmousi, with PML = {tf-t0}")
