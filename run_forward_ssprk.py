...
model["acquisition"] = {
    ...
    "delay": 1.0,
    "num_receivers": 10,
    "receiver_locations": spyro.create_transect((-0.10, 0.1), (-0.10, 7.9), 10),
}
model["timeaxis"] = {
...
dt = spyro.estimate_timestep(mesh, V, vp, estimate_max_eigenvalue=True)
print(dt)
model["timeaxis"]["dt"] = dt*0.6
