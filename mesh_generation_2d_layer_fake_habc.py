...
input_vp_model = "/home/olender/common_files/velocity_models/vp_marmousi-ii.hdf5" #Arquivo para ler o modelo de velocidade .segy ou hdf5
output_mesh_name = "meshes/marmousi_with_temp_habc"  #Onde vamos salvar a malha
...
if show == True:
    ...
    output = fire.File('real_model.pvd')
    output.write(vp)
